...
> **CORRECTION (issued post-publication):** The original version of this brief stated WTI near $71.20 and Brent near $74.80. Those figures were not sourced from the bundle, which carried ETF proxies (USO 132.21, GLD 426.69) rather than barrel prices. Actual settlements were WTI $84.60 and Brent $91.82. The Markets section has been corrected, and the directional call has been reversed: crude fell on the Iran sanctions, it did not rise. The `fx_oil` chart has been regenerated. A second correction: the brief originally stated markets priced ~60% odds of a September rate CUT. CME FedWatch actually shows ~68% HOLD and ~30% HIKE, with no meaningful cut probability. The Macro section has been corrected.
...
The [July FOMC minutes](https://www.federalreserve.gov/newsevents/pressreleases/monetary20260819a.htm), released August 19, showed broad committee agreement to hold at the current rate while monitoring labor market deterioration and tariff passthrough. [CME FedWatch shows roughly 68% probability of a HOLD at the September 16 meeting and about 30% probability of a HIKE](https://www.oddsshopper.com/articles/prediction-markets/fed-rate-cut-odds-september-2026), with no meaningful probability of a cut. The bundle's own data carried this signal and it should have been read directly: the [2-year at 4.24%](https://fred.stlouisfed.org/series/DGS2) sits 61bp ABOVE the [3.63% effective funds rate](https://fred.stlouisfed.org/series/DFF). A 2-year trading above the policy rate prices tightening, not easing. Hike odds fell from roughly two-thirds to one-third only after [the July jobs report showed the economy shedding jobs](https://www.cnbc.com/2026/08/07/odds-the-fed-hikes-in-september-tumble-following-big-july-jobs-miss.html). The Canada tariff escalation today introduces a new inflationary wildcard that the Fed will explicitly need to address in September's SEP, since the auto sector is precisely the supply-chain that tariff passthrough models show transmitting fastest to headline CPI [medium].
