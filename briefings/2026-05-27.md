...
![Summary card, today at a glance](2026-05-27-summary_card.png)

![World today, geocoded events past 24h](2026-05-27-world_today.png)
...
![Markets sparklines, today vs 30-day baseline](2026-05-27-markets_sparklines.png)
...
![United States today: Federal Register actions, congressional activity, regulatory geography](2026-05-27-us_today.png)
...
![Ukraine theater overview, frontline + ACLED events + FIRMS thermal + alert oblasts](2026-05-27-ukraine_theater_overview.png)
*Full theater view. DeepStateMap frontline overlaid on 24h ACLED events (red dots) and FIRMS thermal anomalies (gold). Air-alert oblasts shown with teal fill.*

![Kyiv city + oblast focus](2026-05-27-ukraine_kyiv_focus.png)
*Kyiv zoom. Population density underlay (Kontur HRSL). Strike density and alert state overlaid.*

![Recent damage layer](2026-05-27-ukraine_damage_recent.png)
*UNOSAT + Copernicus EMS damage polygons from the past 7 days where activated.*

![Population at risk](2026-05-27-ukraine_population_at_risk.png)
*Inhabited grid cells (Kontur HRSL) intersected with past-24h FIRMS + ACLED activity envelope.*
...
![Conflict intensity, past 30 days, ACLED + FIRMS geocoded](2026-05-27-conflict_intensity_30d.png)
...
![Paper-bet scorecard, today's placements + week-to-date P&L](2026-05-27-paper_bet_scorecard.png)
...
![Anomaly density, today across all sections, z-score colored](2026-05-27-anomaly_density.png)
...
![Section volume, today vs 14-day rolling median, per section](2026-05-27-section_volume.png)
